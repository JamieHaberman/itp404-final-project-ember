  ...
  exports['default'] = _ember['default'].Controller.extend({
    ...
    actions: {
      createmovie: function createmovie(e) {
        ...
        this.transitionToRoute('results.favorites', movielist);
        var promise = $.ajax({
          type: 'post',
        ...
        promise.then(function () {
          alert('yay');
          var movielist = this.get('model.movielist');
          var newMovie = movielist.concat(response.movielist);
          this.set('model.movielist', newMovie);
        }, function () {
          alert('error');
        });
      }
...
define("crudmovies/templates/search/results", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["content", "outlet", ["loc", [null, [3, 0], [3, 10]]], 0, 0, 0, 0], ["block", "each", [["get", "model.data", ["loc", [null, [5, 12], [5, 22]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [5, 4], [13, 11]]]], ["attribute", "onSubmit", ["subexpr", "action", ["createmovie"], [], ["loc", [null, [null, null], [15, 43]]], 0, 0], 0, 0, 0, 0], ["inline", "input", [], ["type", "text", "value", ["subexpr", "@mut", [["get", "movielist", ["loc", [null, [16, 28], [16, 37]]], 0, 0, 0, 0]], [], [], 0, 0]], ["loc", [null, [16, 0], [16, 39]]], 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
